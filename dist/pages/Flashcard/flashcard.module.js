...
exports.FalshCardModule = void 0;
...
let FalshCardModule = class FalshCardModule {
};
FalshCardModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: "FlashCard", schema: flashcard_schema_1.default }]),
        ],
...
exports.FalshCardModule = FalshCardModule;
